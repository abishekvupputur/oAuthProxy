...
/// threeEyedRaven vaults from them or starts reciting the rest of their password manager back at
/// them.
/// </summary>
public class VaultProfileTests
{
    ...
    public void OnlyVaultsNamedAfterTheDefaultAreRecognised()
    {
        ...
        Assert.True(VaultProfile.Matches("THREEEYEDRAVEN work"));
        Assert.True(VaultProfile.Matches("Work threeEyedRaven"));
