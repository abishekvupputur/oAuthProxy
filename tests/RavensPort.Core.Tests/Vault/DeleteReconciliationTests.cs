...
///
/// This is the riskiest thing the mapper does. RavensPort is a vault in the user's own
...
public class DeleteReconciliationTests
{
    ...
    public async Task AnItemThisAppDoesNotOwnSurvivesEverySave()
    {
        ...
        vault.AddForeignItem("RavensPortish thing without a guid", "also-not-ours");
        ...
        Assert.Contains(vault.Items, i => i.Title == "RavensPortish thing without a guid");
    }
