...
public sealed partial class SettingsViewModel : ObservableObject
{
    ...
    /// than only the items this app can recognise — and so an OAuthProxy item someone renamed is
    ...
    /// <summary>
    /// Deletes an item that is not OAuthProxy's. One at a time and never in bulk: the rest of the
