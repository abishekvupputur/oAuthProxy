...
/// <summary>
/// The naming rule for OAuthProxy's vaults: <c>threeEyedRaven</c> on its own, or
/// <c>threeEyedRaven Work</c> for a named profile.
///
...
{
    /// <summary>
    /// Whether a vault name is one of OAuthProxy's by name alone. Contains rather than
    /// starts-with: a user who called theirs "Work threeEyedRaven" meant the same thing, and
